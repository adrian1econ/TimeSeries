...
dl_sim1 <- arma_sim(phi = 0.7, n=250, burnin=1000)
dl_sim2 <- arma_sim(phi = c(0.6,0.2), n=250, burnin=1000)
dl_sim3 <- arma_sim(phi = c(0.6,-0.2), n=250, burnin=1000)
dl_sim4 <- arma_sim(phi = c(0.7,0.3,-0.2), n=250, burnin=1000)
dl_sim5 <- arma_sim(theta = 0.5, n=250, burnin=1000)
dl_sim6 <- arma_sim(phi=0.5, theta = 0.5, n=250, burnin=1000)
```
...
plot_dl_forecasts(dl_sim3, dl_3, "AR(2) - (0.6,-0.2)")
plot_dl_forecasts(dl_sim4, dl_4, "AR(3) - (0.7,0.3,-0.2)")
plot_dl_forecasts(dl_sim5, dl_5, "MA(1) - (0.5)")
plot_dl_forecasts(dl_sim6, dl_6, "ARMA(1,1) - (0.5, 0,5)")
